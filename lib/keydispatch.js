// The keyCode used here belongs to the browser standard below. Since it's currently deprecated, it might change in the future
...
function dispatchTouchMouseEvent(evt) {
  ...
  canvasEl.dispatchEvent(newEvt); // Deprecate mouse
}
